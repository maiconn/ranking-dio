...
export function UsuarioProvider({children}: ProviderProps) {
  const usuariosDIO = [
    ...
    {nome: 'gabrieltogni', xpDesconto: 1160, xpAdd: 500},
    ...
    {nome: 'guiuser1999', xpDesconto: 0, xpAdd: 900},
    ...
    {nome: 'alissonmanica_aai', xpDesconto: 0, xpAdd: 400},
    {nome: 'schoolartogni', xpDesconto: 0, xpAdd: 0},
  ];
