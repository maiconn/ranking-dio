...
export function UsuarioProvider({children}: ProviderProps) {
  const usuariosDIO = [
    {nome: 'jairoderivia', xpDesconto: 920, xpAdd: 0},
    {nome: 'joaovitor_jf42', xpDesconto: 920, xpAdd: 0},
    {nome: 'alissonmanica_aai', xpDesconto: 1122, xpAdd: 0},
    ...
    {nome: 'thayroni_spr', xpDesconto: 5600, xpAdd: 0},
    ...
    {nome: 'schoolartogni', xpDesconto: 720, xpAdd: 0},
    {nome: 'wagnereduardo34', xpDesconto: 120, xpAdd: 0},
    {nome: 'yanfhausmann', xpDesconto: 2360, xpAdd: 0},
    {nome: 'wesleymeireles_meireles', xpDesconto: 7330, xpAdd: 0},
    ...
    {nome: 'gabriele_jacques', xpDesconto: 120, xpAdd: 0},
    ...
    {nome: 'lucas_roquef', xpDesconto: 5200, xpAdd: 0},
    {nome: 'guiuser1999', xpDesconto: 5780, xpAdd: 0},
