...
export function UsuarioProvider({children}: ProviderProps) {
  const usuariosDIO = [
    ...
    {nome: 'pro_goncalves', xpDesconto: 3894, xpAdd: 500},
    ...
    {nome: 'gabrieltogni', xpDesconto: 1160, xpAdd: 700},
    ...
    {nome: 'jardon_m_martins', xpDesconto: 4965, xpAdd: 1400},
    {nome: 'andregranemann', xpDesconto: 80, xpAdd: 200},
    {nome: 'flaviagoudinho39', xpDesconto: 240, xpAdd: 0},
    {nome: 'lucas_roquef', xpDesconto: 4360, xpAdd: 0},
    {nome: 'guiuser1999', xpDesconto: 0, xpAdd: 1600},
    ...
    {nome: 'alissonmanica_aai', xpDesconto: 0, xpAdd: 700},
    {nome: 'schoolartogni', xpDesconto: 0, xpAdd: 200},
  ];
